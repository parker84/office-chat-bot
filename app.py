...
with st.expander("Not sure what to ask Dwight, try some of these"):
    st.markdown("""
    ```
    1. What is your name?
    2. Where do you work?
...
st.markdown("Feedback/Questions: [join our slack workspace](https://join.slack.com/t/officechatbot/shared_invite/zt-14rlr8chh-C~rwJN~~KUAX~DOkvcno1g)")